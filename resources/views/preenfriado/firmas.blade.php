...
@section('content')
<div class="pagetitle">
  <h1>Firmas de Preenfriado</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('enfrio.mostrar') }}">Preenfriado</a></li>
      <li class="breadcrumb-item"><a href="{{ route('enfrio.mostrarid', $preenfriado->id) }}">Ver Preenfriado</a></li>
...
<section class="section">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Agregar Firmas Digitales - Tarima: {{ $preenfriado->tarima->codigo }}</h5>
      ...
      <form action="{{ route('preenfriado.guardar_firmas', $preenfriado->id) }}" method="POST" id="firmasForm">
        @csrf
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable1" name="nombre_responsable1" 
                   value="{{ old('nombre_responsable1', $preenfriado->nombre_responsable1) }}" required>
          </div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable2" name="nombre_responsable2" 
                   value="{{ old('nombre_responsable2', $preenfriado->nombre_responsable2) }}" required>
          </div>
        ...
        <div class="row mb-4">
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="nota_firmas" name="nota_firmas" rows="4" maxlength="500">{{ old('nota_firmas', $preenfriado->nota_firmas) }}</textarea>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a href="{{ route('enfrio.mostrarid', $preenfriado->id) }}" class="btn btn-secondary">
