        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('tipopallets.guardar') }}">
                @csrf
                {{-- NOMBRE TIPO PALLETS --}}
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-6 col-form-label">Tipo Empaque</label>
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="tipopallet" value="{{ old('tipopallet') }}">
                  </div>
                </div>
                <div class="row mb-3">
