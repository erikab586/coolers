...
@section('content')
<div class="pagetitle">
  <h1>Firmas de Cruce de Andén</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('cruce_anden.mostrar') }}">Cruce de Andén</a></li>
      <li class="breadcrumb-item"><a href="{{ route('cruce_anden.mostrarid', $cruceAnden->id) }}">Ver Cruce de Andén</a></li>
...
<section class="section">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Agregar Firmas Digitales - Tarima: {{ $cruceAnden->tarima->codigo }}</h5>
      ...
      <form action="{{ route('cruce_anden.guardar_firmas', $cruceAnden->id) }}" method="POST" id="firmasForm">
        @csrf
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable1" name="nombre_responsable1" 
                   value="{{ old('nombre_responsable1', $cruceAnden->nombre_responsable1) }}" required>
          </div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable2" name="nombre_responsable2" 
                   value="{{ old('nombre_responsable2', $cruceAnden->nombre_responsable2) }}" required>
          </div>
        ...
        <div class="row mb-4">
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="nota_firmas" name="nota_firmas" rows="4" maxlength="500">{{ old('nota_firmas', $cruceAnden->nota_firmas) }}</textarea>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a href="{{ route('cruce_anden.mostrarid', $cruceAnden->id) }}" class="btn btn-secondary">
