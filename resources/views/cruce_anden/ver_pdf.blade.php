...
<head>
    <meta charset="UTF-8">
    <title>Cruce de Andén - Tarima {{ $cruceAnden->tarima->codigo }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="details-table">
            ...
            <tbody>
                @forelse($cruceAnden->detallesCruceAnden as $detalle)
                    @php
    ...
    <div style="margin-top: 30px;">
        <h3 style="background-color: #f0f0f0; padding: 8px; border-left: 4px solid #17a2b8;">
            ...
            <tr>
                <td style="width: 50%; text-align: center; padding: 10px; vertical-align: top;">
                    <div style="border: 1px solid #ddd; padding: 10px;">
                        <img src="{{ $cruceAnden->firma_responsable1 }}" style="max-width: 200px; height: 80px;">
                        <p style="margin-top: 10px; margin-bottom: 5px;"><strong>{{ $cruceAnden->nombre_responsable1 }}</strong></p>
                        <p style="margin: 0; font-size: 9pt; color: #666;">Responsable 1</p>
                    </div>
                </td>
                <td style="width: 50%; text-align: center; padding: 10px; vertical-align: top;">
                    <div style="border: 1px solid #ddd; padding: 10px;">
                        <img src="{{ $cruceAnden->firma_responsable2 }}" style="max-width: 200px; height: 80px;">
                        <p style="margin-top: 10px; margin-bottom: 5px;"><strong>{{ $cruceAnden->nombre_responsable2 }}</strong></p>
    ...
    <div style="margin-top: 15px; padding: 10px; background-color: #fffacd; border: 1px solid #ddd;">
        <strong>NOTA:</strong> {{ $cruceAnden->nota_firmas }}
    </div>
    @endif
    @endif
