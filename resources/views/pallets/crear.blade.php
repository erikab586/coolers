...
@section('content')
    <div class="pagetitle">
      <h1>Formulario de Tipo Empaque</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Tipo Empaque</li>
          <li class="breadcrumb-item"><a href="{{ route('tipopallets.mostrar') }}">Ver Tipo Empaque</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Crear Tipo Empaque</h5>
              ...
              <form method="POST" action="{{ route('pallets.guardar') }}">
                @csrf
                {{-- NOMBRE PALLET --}}
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-6 col-form-label">Nombre Empaque</label>
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="codigopallet" value="{{ old('codigopallet') }}">
                  </div>
                </div>
                <div class="row mb-3">
