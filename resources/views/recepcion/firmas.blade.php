...
@section('content')
<div class="pagetitle">
  <h1>Firmas de Recepción</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('recepcion.mostrar') }}">Recepciones</a></li>
      <li class="breadcrumb-item"><a href="{{ route('recepcion.show', $recepcion->id) }}">Ver Recepción</a></li>
...
<section class="section">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Agregar Firmas Digitales - Folio: {{ $recepcion->folio }}</h5>
      ...
      <form action="{{ route('recepcion.guardar_firmas', $recepcion->id) }}" method="POST" id="firmasForm">
        @csrf
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable1" name="nombre_responsable1" 
                   value="{{ old('nombre_responsable1', $recepcion->nombre_responsable1) }}" required>
          </div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_responsable2" name="nombre_responsable2" 
                   value="{{ old('nombre_responsable2', $recepcion->nombre_responsable2) }}" required>
          </div>
        ...
        <div class="row mb-4">
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="nota_firmas" name="nota_firmas" rows="4" maxlength="500">{{ old('nota_firmas', $recepcion->nota_firmas) }}</textarea>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a href="{{ route('recepcion.show', $recepcion->id) }}" class="btn btn-secondary">
...
document.getElementById('firmasForm').addEventListener('submit', function(e) {
  ...
  // Primero crear un canvas temporal con fondo blanco para JPEG
