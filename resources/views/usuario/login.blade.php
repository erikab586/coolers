              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Ingresa Email y Password</p>
                  </div>
                  @if ($errors->any())
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('usuario.loguear')}}">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">¿Olvidaste contraseña? <a href="registro.php">Restablecer Password</a></p>
                    </div>
                  </form>
