      ...
      <nav>
        <ol class="breadcrumb">
          ...
          @if(hasPermission('crear_contratos'))
            <li class="breadcrumb-item"><a href="{{ route('contrato.crear') }}">Crear Contrato</a></li>
          @endif
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Contratos <span>| Todas</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          @if(hasAnyPermission(['editar_contratos', 'eliminar_contratos']))
                            <td>
                              @if(hasPermission('editar_contratos'))
                                {{-- Botón Editar --}}
                                <a href="{{ route('contrato.editar', $contrato->id) }}" class="btn btn-sm btn-success" title="Editar">
                                  <i class="bi bi-pencil-square"></i>
                                </a>
                              @endif

                              @if(hasPermission('eliminar_contratos'))
                                {{-- Botón Eliminar --}}
                                <a href="{{ route('contrato.eliminar', $contrato->id) }}" class="btn btn-sm btn-danger" title="Eliminar">
