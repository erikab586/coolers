...
@section('content')
    <div class="pagetitle">
      <h1>Formulario de Variedad</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Variedad</li>
          <li class="breadcrumb-item"><a href="{{ route('variedad.mostrar') }}">Ver Variedades</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Crear Variedad</h5>
              ...
              <form method="POST" action="{{ route('variedad.guardar') }}">
                @csrf
                {{-- NOMBRE FRUTA --}}
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-6 col-form-label">Nombre Variedad</label>
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="tipofruta" value="{{ old('tipofruta') }}">
                  </div>
                </div>
                <div class="row mb-3">
